...
<td class="bodyContainer" valign="top" >
	...
	<p><h3>type:</h3> ${result.type}</p>
	<p><a href="/OMEN/GetValue?id=${result.id}">ARFF Data</a> - one file overall</p>
	<p><A href="/OMEN/GetValueZip?id=${result.id}">ARFF Data zipped</A> - one file per piece</p>
	<p><h3>File List</h3></p>
	<table>
	<tr>
		<td><b>Album</b></td>
